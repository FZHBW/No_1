...
class Naive_Bayes:
    def __init__(self):
        #读入图像并构建窗口对象，准备初始数据
        self.img= mpimg.imread('/Users/huangyh/Documents/PythonLearning/Model/No_1/IMG_0578.jpg')
    ...
    def separate(self):
        img0= mpimg.imread('/Users/huangyh/Documents/PythonLearning/Model/No_1/IMG_0580.jpg')
        data0=np.array(img0)
        maxw=img0.shape[0]
        maxl=img0.shape[1]
        tx,ty=0,0
