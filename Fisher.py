...
class Fisher_select:
    ...
    def __init__(self):
        self.img= mpimg.imread('/Users/huangyh/Documents/PythonLearning/Model/No_1/IMG_0580.jpg')
    ...
    def separate(self):
        img0= mpimg.imread('/Users/huangyh/Documents/PythonLearning/Model/No_1/IMG_0578.jpg')
        data0=np.array(img0)
        maxw=img0.shape[0]
        maxl=img0.shape[1]
        tx,ty=0,0
